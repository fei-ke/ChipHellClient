...
public final class PlateGroupView_
    extends PlateGroupView
    implements HasViews, OnViewChangedListener
{
    ...
    public PlateGroupView_(Context context) {
        super(context);
        init_();
    }

    public static PlateGroupView build(Context context) {
        PlateGroupView_ instance = new PlateGroupView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.layout_plate_group, this);
