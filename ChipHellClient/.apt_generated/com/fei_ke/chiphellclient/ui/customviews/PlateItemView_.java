...
public final class PlateItemView_
    extends PlateItemView
    implements HasViews, OnViewChangedListener
{
    ...
    public PlateItemView_(Context context) {
        super(context);
        init_();
    }

    public static PlateItemView build(Context context) {
        PlateItemView_ instance = new PlateItemView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.layout_plate_item, this);
